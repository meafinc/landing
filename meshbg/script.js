...
class MeshRenderer {
    ...
    createShaderProgram() {
        const vertexShader = this.createShader(this.gl, this.gl.VERTEX_SHADER, vShader);
        const fragmentShader = this.createShader(this.gl, this.gl.FRAGMENT_SHADER, fShader);
